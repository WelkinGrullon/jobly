  ...
  return (
        <main className="  bg-gray-50 flex flex-row h-screen justify-center items-center lg:p-20  ">
          ...
          />
            ...
            <input placeholder='name' className='border-2 p-2 border-blue-200  rounded-md focus:outline-blue-500' type='text' />
              ...
              <input placeholder='confirm password' className=' border-2 p-2 border-blue-200 rounded-md focus:outline-blue-500' type='password' />
              <input className=' text-gray-300 bg-jobly p-2 rounded cursor-pointer' type='submit' value='Register ' />
            </form>
